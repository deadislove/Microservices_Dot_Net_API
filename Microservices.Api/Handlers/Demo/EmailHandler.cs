...
{
    public class EmailHandler : INotificationHandler<DemoAddedNotification>
    {
        private readonly DemoServices _demo;
        private readonly ILogger<Enterprise_MVC_Core> _logger;

        public EmailHandler(IGenericTypeRepository<Enterprise_MVC_Core> repo, ILogger<Enterprise_MVC_Core> logger)
        {
        ...
        {
            await _demo.EventOccured(notification.Enterprise_MVC_Core, "Email sent");
